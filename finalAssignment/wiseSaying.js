...
const say = document.querySelector("#quote div:first-child");
const author = document.querySelector("#quote div:last-child");
const todaySay = saying[Math.round(Math.random() * saying.length)];

say.innerText = todaySay.saying;
author.innerText = todaySay.author;
